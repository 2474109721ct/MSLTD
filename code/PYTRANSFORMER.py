...
class UpSample(nn.Module):
    def __init__(self, d_model, size):
        ...
        self.conv_up = nn.ConvTranspose1d(in_channels=d_model, out_channels=d_model // 2, kernel_size=3, stride=2, padding=1)
        self.size = size
...
if __name__ == "__main__":
    ...
    model = PyramidTransformer(seq_len=seq_len, d_model=d_model, heads=4, num_layers=2, dim_head=32, mlp_dim=128, dropout=0.1)
